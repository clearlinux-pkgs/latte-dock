...
Version  : 0.9.4
Release  : 9
URL      : https://github.com/KDE/latte-dock/archive/v0.9.4/latte-dock-0.9.4.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.4/latte-dock-0.9.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572186745
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/latte-dock-0.9.4/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.4/COPYING.LIB %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/latte-dock-0.9.4/containment/package/contents/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.4/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.4/shell/package/contents/images/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
