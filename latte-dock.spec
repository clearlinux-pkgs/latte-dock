...
Version  : 0.9.0
Release  : 5
URL      : https://github.com/KDE/latte-dock/archive/v0.9.0/latte-dock-0.9.0.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.0/latte-dock-0.9.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564415290
mkdir -p clr-build
pushd clr-build
