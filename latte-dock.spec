...
Version  : 0.9.1
Release  : 6
URL      : https://github.com/KDE/latte-dock/archive/v0.9.1/latte-dock-0.9.1.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.1/latte-dock-0.9.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564949989
mkdir -p clr-build
pushd clr-build
