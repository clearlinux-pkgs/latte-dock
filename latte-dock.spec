...
Version  : 0.8.7
Release  : 2
URL      : https://github.com/KDE/latte-dock/archive/v0.8.7.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.8.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552488355
mkdir -p clr-build
pushd clr-build
