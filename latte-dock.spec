...
Version  : 0.8.97
Release  : 4
URL      : https://github.com/KDE/latte-dock/archive/v0.8.97/latte-dock-0.8.97.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.8.97/latte-dock-0.8.97.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563422339
mkdir -p clr-build
pushd clr-build
