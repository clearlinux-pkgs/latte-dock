...
Version  : 0.9.3
Release  : 8
URL      : https://github.com/KDE/latte-dock/archive/v0.9.3/latte-dock-0.9.3.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.3/latte-dock-0.9.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569780454
mkdir -p clr-build
pushd clr-build
