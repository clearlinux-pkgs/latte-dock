...
%prep
%setup -q -n latte-dock-0.10.9
cd %{_builddir}/latte-dock-0.10.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702012324
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt5/plugins/kpackage/packagestructure/latte_packagestructure_indicator.so
/V3/usr/lib64/qt5/plugins/plasma_containmentactions_lattecontextmenu.so
/V3/usr/lib64/qt5/qml/org/kde/latte/core/liblattecoreplugin.so
/V3/usr/lib64/qt5/qml/org/kde/latte/private/containment/liblattecontainmentplugin.so
/V3/usr/lib64/qt5/qml/org/kde/latte/private/tasks/liblattetasksplugin.so
