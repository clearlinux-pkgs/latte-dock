...
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.9/latte-dock-0.9.9.tar.gz
...
%prep
%setup -q -n latte-dock-0.9.9
cd %{_builddir}/latte-dock-0.9.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582770197
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/latte-dock-0.9.9/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.9/COPYING.LIB %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/latte-dock-0.9.9/containment/package/contents/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.9/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.9/shell/package/contents/images/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
