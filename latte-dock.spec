...
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.7/latte-dock-0.9.7.tar.gz
...
%prep
%setup -q -n latte-dock-0.9.7
cd %{_builddir}/latte-dock-0.9.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578154632
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/latte-dock-0.9.7/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.7/COPYING.LIB %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/latte-dock-0.9.7/containment/package/contents/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.7/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.7/shell/package/contents/images/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
