...
Version  : 0.9.8.1
Release  : 12
URL      : https://github.com/KDE/latte-dock/archive/v0.9.8.1/latte-dock-0.9.8.1.tar.gz
Source0  : https://github.com/KDE/latte-dock/archive/v0.9.8.1/latte-dock-0.9.8.1.tar.gz
...
%prep
%setup -q -n latte-dock-0.9.8.1
cd %{_builddir}/latte-dock-0.9.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580140337
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/latte-dock-0.9.8.1/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.8.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/latte-dock-0.9.8.1/containment/package/contents/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.8.1/icons/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/latte-dock-0.9.8.1/shell/package/contents/images/COPYING %{buildroot}/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
...
/usr/share/plasma/plasmoids/org.kde.latte.containment/contents/ui/AutomaticItemSizer.qml
...
/usr/share/plasma/plasmoids/org.kde.latte.containment/contents/ui/layouts/indicator/Bridge.qml
/usr/share/plasma/plasmoids/org.kde.latte.containment/contents/ui/layouts/indicator/Loader.qml
...
/usr/share/package-licenses/latte-dock/01a6b4bf79aca9b556822601186afab86e8c4fbf
/usr/share/package-licenses/latte-dock/4cc77b90af91e615a64ae04893fdffa7939db84c
